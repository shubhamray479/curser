            ...
            {[
              ...
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <img className="w-full h-48 object-cover rounded-lg" src={album.image} alt={album.name} />
                  </div>
            ...
            {[
              ...
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <img className="w-full h-48 object-cover rounded-lg" src={item.image} alt={item.name} />
                  </div>
